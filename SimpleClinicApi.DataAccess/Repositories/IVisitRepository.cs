...
namespace SimpleClinicApi.DataAccess.Repositories
{
   public interface IVisitRepository : IRepository<Visit>
   {
      ...
      public Task AddVisitProceduresRangeAsync(IEnumerable<VisitProcedure> procedures, CancellationToken ct);

      public Task AddVisitMedicationsRangeAsync(IEnumerable<VisitMedication> medications, CancellationToken ct);

      public void RemoveVisitProcedures(Visit visit, IEnumerable<VisitProcedure> proceduresToKeep);

      public Task AddOrUpdateVisitProceduresAsync(Visit visit, IEnumerable<VisitProcedure> procedures,
                                                  CancellationToken cancellationToken);

      public void RemoveVisitMedications(Visit visit, IEnumerable<VisitMedication> medicationsToKeep);

      public Task AddOrUpdateVisitMedicationsAsync(Visit visit, IEnumerable<VisitMedication> medications,
                                                   CancellationToken cancellationToken);
   }
}