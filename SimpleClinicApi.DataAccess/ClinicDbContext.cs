...
public class ClinicDbContext(DbContextOptions<ClinicDbContext> options) : IdentityDbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Visit>().HasIndex(v => v.DoctorId).HasDatabaseName("IX_Visit_DoctorId");
        ...
        modelBuilder
            .Entity<VisitMedication>()
            .HasIndex(vm => new { vm.VisitId, vm.MedicationId })
            .HasDatabaseName("IX_VisitMedication_Visit_Medication");

        modelBuilder.Entity<Procedure>().HasIndex(p => p.Name).HasDatabaseName("IX_Procedure_Name");
    ...
    )
    {
        ...
        await context.Patients.AddRangeAsync([patient1, patient2, patient3], cancellationToken);
        ...
        await context.Doctors.AddRangeAsync([doctor1, doctor2, doctor3], cancellationToken);
        ...
        await context.Procedures.AddRangeAsync([proc1, proc2, proc3], cancellationToken);
        ...
        await context.Medications.AddRangeAsync([med1, med2, med3], cancellationToken);
        ...
        await context.Visits.AddRangeAsync([visit1, visit2, visit3], cancellationToken);
        ...
        await context.VisitProcedures.AddRangeAsync([vp1, vp2, vp3], cancellationToken);
        ...
        await context.VisitMedications.AddRangeAsync([vm1, vm2, vm3], cancellationToken);
