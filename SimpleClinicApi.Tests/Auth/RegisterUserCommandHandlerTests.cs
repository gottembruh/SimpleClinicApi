...
public class RegisterUserCommandHandlerTests
{
    ...
    {
        var user = new IdentityUser { UserName = "testuser", Email = "test@mail.com" };
        ...
        mapperMock.Setup(m => m.Map<IdentityUser>(It.IsAny<RegisterDto>())).Returns(user);
        ...
        var command = new RegisterUserCommand(
            new RegisterDto("testuser", "test@mail.com", "Qq!12345")
        );
    ...
    public async Task Handle_ShouldThrowRestException_WhenRegistrationFails()
    {
        ...
        mapperMock
            .Setup(m => m.Map<IdentityUser>(It.IsAny<RegisterDto>()))
        ...
        var command = new RegisterUserCommand(
            new RegisterDto(UserName: "testuser", Email: "test@mail.com", Password: "Qq!12345")
        );
